...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/05/19 12:17:55 by sokhacha          #+#    #+#             */
/*   Updated: 2023/05/19 12:18:34 by sokhacha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (address->cub->map[i][j] == 'S')
	{
		init_dir(address, 1, 0);
		init_plane(address, 0, -0.66);
	}
	else if (address->cub->map[i][j] == 'N')
	{
		init_dir(address, -1, 0);
		init_plane(address, 0, 0.66);
	}
	else if (address->cub->map[i][j] == 'E')
	{
		init_dir(address, 0, 1);
		init_plane(address, 0.66, 0);
	}
	else if (address->cub->map[i][j] == 'W')
	{
		init_dir(address, 0, -1);
		init_plane(address, -0.66, 0);
	}
