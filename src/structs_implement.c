...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/05/19 12:20:33 by sokhacha          #+#    #+#             */
/*   Updated: 2023/05/19 12:20:38 by sokhacha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	address->cub = malloc(sizeof(t_cub));
	address->cub->c_color[0] = 0;
	address->cub->c_color[1] = 0;
	address->cub->c_color[2] = 0;
	address->cub->f_color[0] = 0;
	address->cub->f_color[1] = 0;
	address->cub->f_color[2] = 0;
	address->cub->map = NULL;
	address->cub->ea = NULL;
	address->cub->we = NULL;
	address->cub->so = NULL;
	address->cub->no = NULL;
